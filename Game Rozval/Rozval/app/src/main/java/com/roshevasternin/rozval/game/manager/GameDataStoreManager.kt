...
import com.roshevasternin.rozval.appContext
...
object GameDataStoreManager: AbstractDataStore() {
    ...
    object Star: AbstractDataStore.DataStoreElement<Int>() {
        override val key = intPreferencesKey("star")
    }
    object Key: AbstractDataStore.DataStoreElement<Int>() {
        override val key = intPreferencesKey("key")
    }
    object Level: AbstractDataStore.DataStoreElement<String>() {
